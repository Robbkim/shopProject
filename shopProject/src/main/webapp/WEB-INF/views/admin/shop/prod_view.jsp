...
<div align="center">
	<form name="f" action="shop_prodList.do" method="post">
		<table border="0" width="750" class="outline">
			...
			<tr>
				...
				<td colspan="3" align="center">
					<img src="resources/img/${getProduct.pimage}" width="60" height="60">
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3">
					<textarea name="pcontents" rows="5" cols="90" readOnly>${getProduct.pcontents}</textarea>
				</td>
			</tr>
			<tr>
